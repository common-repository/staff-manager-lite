jQuery(document).ready(function () {
    ...
    setInterval(function () {
        ...
        var currentDateTimeCentralTimeZone1 = new Date(currentUtcTime1.toLocaleString('en-US', { timeZone: ajax_login.wprsmp_timezone }));
    ...
    setInterval(function () {
        ...
        var currentDateTimeCentralTimeZone2 = new Date(currentUtcTime2.toLocaleString('en-US', { timeZone: ajax_login.wprsmp_timezone }));
        var minutes = currentDateTimeCentralTimeZone2.getMinutes();
        jQuery(".min").html((minutes < 10 ? "0" : "") + minutes);
    }, 1000);
    setInterval(function () {
        var currentUtcTime3 = new Date(); // This is in UTC
        var currentDateTimeCentralTimeZone3 = new Date(currentUtcTime3.toLocaleString('en-US', { timeZone: ajax_login.wprsmp_timezone }));
    ...
    jQuery(document).on('click', '.clock-action-btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_front_clock_action',
                timezone: timezone,
                value: value,
                nounce: nounce,
            },
    ...
    jQuery(document).on('click', '#late_reson_submit_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_front_late_reson_action',
                staff_id: staff_id,
                reson: reson,
                nounce: nounce,
            },
    ...
    jQuery(document).on('click', '#daily_report_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_front_daily_report_action',
                staff_id: staff_id,
                report: report,
                nounce: nounce,
            },
