		     	...
		     	<div class="card">
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" method="post" id="edit_request_form">
	                      ...
	                      <input type="text" class="form-control" id="edit_request_name" placeholder="<?php esc_html_e( 'Name', 'staff-manger-lite' ); ?>" readonly>
	                    </div>
	                    <div class="form-group">
	                      <label for="edit_notice_desc"><?php esc_html_e( 'Request Description', 'staff-manger-lite' ); ?></label>
	                      <textarea class="form-control" rows="4" id="edit_notice_desc" name="edit_notice_desc" placeholder="<?php esc_html_e( 'Description....', 'staff-manger-lite' ); ?>" readonly></textarea>
                        </div>
                        <div class="form-group">
	                      <label for="edit_holiday_start"><?php esc_html_e( 'Holiday From', 'staff-manger-lite' ); ?></label>
	                      <input type="text" class="form-control" name="edit_holiday_start" id="edit_holiday_start" placeholder="<?php esc_html_e( 'Format:- YYYY-MM-DD', 'staff-manger-lite' ); ?>" readonly>
	                    </div>
	                    <div class="form-group">
	                      <label for="edit_holiday_to"><?php esc_html_e( 'Holiday To', 'staff-manger-lite' ); ?></label>
	                      <input type="text" class="form-control" id="edit_holiday_to" placeholder="<?php esc_html_e( 'Format:- YYYY-MM-DD', 'staff-manger-lite' ); ?>" readonly>
						</div>
						<div class="form-group">
	                      	<label for="edit_request_status"><?php esc_html_e( 'Status', 'staff-manger-lite' ); ?></label>
	                      	<select name="edit_request_status" id="edit_request_status" class="form-control">
	                      		<option value="Pending"><?php esc_html_e( 'Pending', 'staff-manger-lite' ); ?></option>
	                      		<option value="Approved"><?php esc_html_e( 'Approved', 'staff-manger-lite' ); ?></option>
	                      		<option value="Canceled"><?php esc_html_e( 'Canceled', 'staff-manger-lite' ); ?></option>
	                      	</select>
	                    </div>
