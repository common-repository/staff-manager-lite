	      	...
	      	<nav aria-label="breadcrumb project">
	            ...
	            <li class="breadcrumb-item active" aria-current="page">
	            	<button class="btn btn-block btn-lg btn-gradient-primary custom-btn" data-toggle="modal" data-target="#AddProjects">
	            		<i class="fas fa-plus"></i> <?php esc_html_e( 'Add Project', 'staff-manger-lite' ); ?>
	            	</button>
	          	</li>
	        	</ul>
	      	</nav>
								...
								<tr>
									...
									<td class="designation-action-tools">
										<ul class="designation-action-tools-ul">
											...
											<li class="designation-action-tools-li">
												<a href="#" title="<?php esc_html_e( 'Edit', 'staff-manger-lite' ); ?>" class="designation-action-tools-a project-edit-a" data-project="<?php echo esc_attr( $key ); ?>">
													<i class="fas fa-pencil-alt"></i>
												</a>
											</li>
											<li class="designation-action-tools-li">
												<a href="#" title="<?php esc_html_e( 'Delete', 'staff-manger-lite' ); ?>" class="designation-action-tools-a project-delete-a" data-project="<?php echo esc_attr( $key ); ?>">
