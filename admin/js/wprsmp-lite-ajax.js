...
jQuery(document).ready(function () {
    ...
    /***-----------------------------------------------------------Chart js-----------------------------------------------------------***/
    try {
        new Chart(document.getElementById("Task_status"), {
            type: 'doughnut',
            data: {
              labels: ['No Progress', 'In Progress', 'Completed'],
              datasets: [
                {
                  label: "Task Status",
                  backgroundColor: [
    ...
    jQuery(document).on('click', '#add_designation_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_designation_action',
                name: name,
                color: color,
                status: status,
                nounce: nounce,
    ...
    jQuery(document).on('click', '.designation-edit-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_designation_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
                if ( response ) {
                	if ( response == 'Something went wrong.!' ) {
                        ...
                        jQuery( '#edit_designation_form #edit_designation_name' ).val(response.name);
                        jQuery( '#edit_designation_form #edit_designation_color' ).val(response.color);
                        jQuery( '#edit_designation_form .wp-color-result').css('background-color', response.color);                     
                        jQuery( '#edit_designation_form #edit_designation_status' ).val(response.status);
    ...
    jQuery(document).on('click', '#edit_designation_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_designation_action',
                name: name,
                key: key,
                color: color,
                status: status,
    ...
    jQuery(document).on('click', '.designation-delete-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_designation_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#add_shift_btn', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_shift_action',
                name: name,
                start: start,
                end: end,
                late: late,
    ...
    jQuery(document).on('click', '.shift-delete-a', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_shift_action',
                shift_key: shift_key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '.shift-edit-a', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_shift_action',
                shift_key: shift_key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#edit_shift_btn', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_shift_action',
                name: name,
                start: start,
                end: end,
                late: late,
    ...
    jQuery(document).on('click', '#add_event_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_event_action',
                name: name,
                desc: desc,
                date: date,
                time: time,
    ...
    jQuery(document).on('click', '.event-edit-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_event_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#edit_event_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_event_action',
                desc: desc,
                name: name,
                key: key,
                date: date,
    ...
    jQuery(document).on('click', '.event-delete-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_event_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#add_notice_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_notice_action',
                name: name,
                desc: desc,
                status: status,
                nounce: nounce,
    ...
    jQuery(document).on('click', '.notice-edit-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_notice_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#edit_notice_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_notice_action',
                desc: desc,
                name: name,
                key: key,
                status: status,
    ...
    jQuery(document).on('click', '.notice-delete-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_notice_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#add_holiday_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_holiday_action',
                name: name,
                start: start,
                to: to,
                status: status,
    ...
    jQuery(document).on('click', '.holiday-edit-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_holiday_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#edit_holiday_btn', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_holiday_action',
                name: name,
                start: start,
                to: to,
                key: key,
    ...
    jQuery(document).on('click', '.holiday-delete-a', function (e) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_holiday_action',
                key: key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('change keyup keydown', '#select_user_id', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_fetch_staff_action',
                staff_key: staff_key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#add_staff_btn', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_add_staff_action',
                name: name,
                first: first,
                last: last,
                email: email,
    ...
    jQuery(document).on('click', '.staff-edit-a', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_edit_staff_action',
                staff_key: staff_key,
                nounce: nounce,
            },
            success: function ( response ) {
    ...
    jQuery(document).on('click', '#edit_staff_btn', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_staff_action',
                name: name,
                first: first,
                last: last,
                email: email,
    ...
    jQuery(document).on('click', '.staff-delete-a', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_staff_action',
                staff_key: staff_key,
                nounce: nounce,
            },
            success: function ( response ) {
            ...
            success: function ( response ) {
                if ( response ) {
                    if ( response == 'Request not added' || response == 'Something went wrong.!' ) {
                        ...
                        jQuery( '#request_tbody' ).append(response.html);
    ...
    jQuery(document).on('click', '#edit_request_btn', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_update_req_action',
                key: key,
                name: name,
                desc: desc,
                start: start,
    ...
    jQuery(document).on('click', '.request-delete-a', function () {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wprsmp_delete_req_action',
                request_key: request_key,
                nounce: nounce,
            },
            success: function ( response ) {
